...
def seed_cartItems():
    cartItem1 = CartItem(
        quantity = 2, cart_id = 1, item_id= 1
    )
    cartItem2 = CartItem(
        item_id = 2, cart_id = 1, quantity = 1
        
    )
    cartItem3 = CartItem(
       item_id = 3, cart_id = 2, quantity = 1
        
    )
    cartItem4 = CartItem(
        item_id = 4, cart_id = 3, quantity = 1
       
    )
    cartItem5 = CartItem(
       item_id = 5, cart_id = 2, quantity = 2
